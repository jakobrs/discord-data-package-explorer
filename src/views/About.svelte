...
<div class="about">
    <div>
        ...
        <ul>
            ...
            <br>
            <li>A Rust port of <a href="https://diswho.androz2091.fr" target="_blank">https://diswho.androz2091.fr</a>, hosted on <a href="https://girafarig.tailc379a.ts.net/get-data" target="_blank">https://girafarig.tailc379a.ts.net/get-data</a> - this is an API that resolves Discord user data (name, avatar, etc.) from a Discord user ID. This is required to show you nicely displayed data instead of ugly user IDs.</li>
        </ul>
